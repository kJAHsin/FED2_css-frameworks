...
class SkinnyHeader extends HTMLElement {
	...
	connectedCallback() {
		...
		header.innerHTML = `
            <div class="desk:py-chub desk:px-med pad:py-med pad:px-skinny mob:py-skinny mob:px-skinny max-w-wrapper mx-auto  flex justify-between items-center isolate">
                <a class="group" href="/"><h1 class="text-tea_green-600 text-4xl relative after:content-[''] after:absolute after:h-med after:aspect-square after:rounded-full after:bg-none group-hover:after:bg-nyanza-200 after:-left-5 after:-top-0 after:-z-10 after:transition-all after:duration-700">FAKE
